...
contains
  ...
  subroutine gram_schmidt_project (g, dg, y, dy, y2, x, dx)
    ...
    do a=0,3
       ...
       do d=0,3
          do e=0,3
             z(a) = z(a) - g(d,e) * x(d) * y(e) * y(a) * y2_inv
          end do
       end do
    end do
    ...
    do a=0,3
       do b=0,3
          ...
          do d=0,3
             do e=0,3
                dz(a,b) = dz(a,b) &
                     - y2_inv * (dg(d,e,b) * x(d) * y(e) * y(a) * y2_inv &
                     + g(d,e) * dx(d,b) * y(e) * y(a) &
                     + g(d,e) * x(d) * dy(e,b) * y(a) &
                     + g(d,e) * x(d) * y(e) * dy(a,b))
!!$                dz(a,b) = dz(a,b) &
!!$                     - dg(d,e,b) * x(d) * y(e) * y(a) * y2_inv &
!!$                     - g(d,e) * dx(d,b) * y(e) * y(a) * y2_inv &
!!$                     - g(d,e) * x(d) * dy(e,b) * y(a) * y2_inv &
!!$                     - g(d,e) * x(d) * y(e) * dy(a,b) * y2_inv
             end do
          end do
       end do
    end do
